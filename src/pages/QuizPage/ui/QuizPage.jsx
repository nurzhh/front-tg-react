...
const QuizPage = () => {
    ...
    return (
        <div className="quiz-page fade-in">
            ...
            <input type="text" placeholder="Введите ваш ответ" value={currentAnswer} onChange={handleInputChange}/>
            <div className="button-container">
                {currentQuestion < questions.length - 1 ? (
                    <Button variant={currentAnswer ? 'secondary' : 'primary'} onClick={handleNextQuestion}
                            disabled={currentAnswer.trim() === ""}>
                        Далее
                    </Button>
                ) : (
                    <Button class onClick={handleSubmit} disabled={currentAnswer.trim() === ""}>
                        Отправить
                    </Button>
                )}
            </div>
